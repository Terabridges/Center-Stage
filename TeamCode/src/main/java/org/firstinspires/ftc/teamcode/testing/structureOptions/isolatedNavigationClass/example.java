...
public class example extends LinearOpMode {
    ...
    MecDT drivetrain = hardware.getDrivetrain();
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double robotDirection = hardware.getIMU().getRobotYawPitchRollAngles().getYaw(AngleUnit.RADIANS);
            ...
            if(transMode == 1) {
                drivetrain.absMecPow(robotDirection, -gamepad1.left_stick_y, -gamepad1.left_stick_x, rot);
            }else{
                drivetrain.mecPow(-gamepad1.left_stick_y, -gamepad1.left_stick_x, rot);
            }
